// THROWAWAY — Alpha Engine PoC (docs/alpha_engine_poc_v1.pdf) — self-contained HTML visualisation.
//
...
<title>Alpha Engine PoC — Run Visualisation</title>
<style>
  :root {
...
<body>
<header>
  <h1>Alpha Engine PoC <span class="pill">THROWAWAY · R&amp;D</span></h1>
...
<footer>Generated by <code>@throwaway/alpha-engine</code> — open from disk, no server required.</footer>
